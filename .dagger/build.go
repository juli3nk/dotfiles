...
type DotfilesBuild struct {
	Git    *Git
	BinDir *dagger.Directory
}

// Build binaries
func (m *Dotfiles) Build(
	ctx context.Context,
	// +optional
	version string,
) (*DotfilesBuild, error) {
	...
	return &DotfilesBuild{
		Git:    m.Git,
		BinDir: output,
	}, nil
}

func (m *DotfilesBuild) Stdout(ctx context.Context) (string, error) {
...
func (m *DotfilesBuild) Dir() *dagger.Directory {
	return m.BinDir
}
